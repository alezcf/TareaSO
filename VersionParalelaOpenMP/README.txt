Procesamiento Paralelo Open MP
...
Antes de ejecutar el código, debes considerar lo siguiente:
    ...
    - Threads a utilizar: Para modificar la cantidad de hilos a utilizar, debes dirigirte a la línea 12 del código (omp_set_num_threads(4);) y cambiar manualmente al número que deseas utilizar. Predefinidamente está con 4 threads.
